      ...
      <nav className="page-header-nav">
        ...
        <div className="page-header-left">
          <div className="page-header-nav-left">
            <div className="page-header-nav-btns">
              <div
              ...
              >
                <a>MENSWEAR</a>
                <svg
                  className={`page-header-icn ${activeBtn === "menswear" && menuOpen ? "flipped" : ""}`}
                  width="7"
                  height="6"
                  viewBox="0 0 7 6"
                  fill="none"
              ...
              >
                <a>WOMENSWEAR</a>
                <svg
                  className={`page-header-icn ${activeBtn === "womenswear" && menuOpen ? "flipped" : ""}`}
                  width="7"
                  height="6"
                  viewBox="0 0 7 6"
                  fill="none"
              ...
              >
                <a>DESIGNERS</a>
                <svg
                  className={`page-header-icn ${activeBtn === "designers" && menuOpen ? "flipped" : ""}`}
                  width="7"
                  height="6"
                  viewBox="0 0 7 6"
                  fill="none"
          ...
          <div className={`page-header-nav-btns ${searchOpen ? "search-active" : ""}`}>
            <div className={`page-header-search-wrapper ${searchOpen ? "open" : ""}`}>
              ...
              >
                <svg
                  className="page-header-icn page-header-search-trigger-icn"
                  width="14"
                  height="14"
                  viewBox="0 0 12 12"
                  fill="none"
              ...
              <div className="page-header-search-bar">
                <svg
                  className="page-header-search-icn"
                  width="10"
                  height="10"
                  viewBox="0 0 12 12"
                  fill="none"
                ...
                <span className="page-header-search-divider"></span>
                <input
                  type="text"
